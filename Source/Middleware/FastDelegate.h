...
public:
  // we want to eliminate the inline calls in debug
...
public:
	...
	return (m_Closure.m_pthis->*(reinterpret_cast<GenericMemFn>(m_Closure.m_pFunction)))(); }
...
public:
	...
	return (m_Closure.m_pthis->*(reinterpret_cast<GenericMemFn>(m_Closure.m_pFunction)))(p1); }
	// Implicit conversion to "bool" using the safe_bool idiom
private:
	typedef struct SafeBoolStruct {
		int a_data_pointer_to_this_is_0_on_buggy_compilers;
...
public:
	...
	return (m_Closure.m_pthis->*(reinterpret_cast<GenericMemFn>(m_Closure.m_pFunction)))(p1, p2); }
	// Implicit conversion to "bool" using the safe_bool idiom
private:
	typedef struct SafeBoolStruct {
		int a_data_pointer_to_this_is_0_on_buggy_compilers;
...
public:
	...
	return (m_Closure.m_pthis->*(reinterpret_cast<GenericMemFn>(m_Closure.m_pFunction)))(p1, p2, p3); }
	// Implicit conversion to "bool" using the safe_bool idiom
private:
	typedef struct SafeBoolStruct {
		int a_data_pointer_to_this_is_0_on_buggy_compilers;
...
public:
	...
	return (m_Closure.m_pthis->*(reinterpret_cast<GenericMemFn>(m_Closure.m_pFunction)))(p1, p2, p3, p4); }
	// Implicit conversion to "bool" using the safe_bool idiom
private:
	typedef struct SafeBoolStruct {
		int a_data_pointer_to_this_is_0_on_buggy_compilers;
...
public:
	...
	return (m_Closure.m_pthis->*(reinterpret_cast<GenericMemFn>(m_Closure.m_pFunction)))(p1, p2, p3, p4, p5); }
	// Implicit conversion to "bool" using the safe_bool idiom
private:
	typedef struct SafeBoolStruct {
		int a_data_pointer_to_this_is_0_on_buggy_compilers;
...
public:
	...
	return (m_Closure.m_pthis->*(reinterpret_cast<GenericMemFn>(m_Closure.m_pFunction)))(p1, p2, p3, p4, p5, p6); }
	// Implicit conversion to "bool" using the safe_bool idiom
private:
	typedef struct SafeBoolStruct {
		int a_data_pointer_to_this_is_0_on_buggy_compilers;
...
public:
	...
	return (m_Closure.m_pthis->*(reinterpret_cast<GenericMemFn>(m_Closure.m_pFunction)))(p1, p2, p3, p4, p5, p6, p7); }
	// Implicit conversion to "bool" using the safe_bool idiom
private:
	typedef struct SafeBoolStruct {
		int a_data_pointer_to_this_is_0_on_buggy_compilers;
...
public:
	...
	return (m_Closure.m_pthis->*(reinterpret_cast<GenericMemFn>(m_Closure.m_pFunction)))(p1, p2, p3, p4, p5, p6, p7, p8); }
	// Implicit conversion to "bool" using the safe_bool idiom
private:
	typedef struct SafeBoolStruct {
		int a_data_pointer_to_this_is_0_on_buggy_compilers;
